...
public class ustadDua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ustad_dua);
        rv = (RecyclerView) findViewById(R.id.rv);
        parsingData("Ceramah felix siauw terbaru 2018");
    ...
    private void parsingData(String types) {
        ...
        SampleAPI.Factory.getIstance(ustadDua.this).getData(url).enqueue(new Callback<ModelVid>() {
            @Override
            public void onResponse(Call<ModelVid> call, Response<ModelVid> response) {
                if (response.isSuccessful()) {
                    datanya1 = response.body().getItems();
                    adapter = new itemlist(ustadDua.this, datanya1);
            ...
            public void onFailure(Call<ModelVid> call, Throwable t) {
                //pd.dismiss();
                Toast.makeText(ustadDua.this, "Error : " + t.getMessage(), Toast.LENGTH_LONG).show();
